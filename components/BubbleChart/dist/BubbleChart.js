...
var BubbleChart = function () {
    ...
    return (react_1["default"].createElement("div", null,
        ...
        react_1["default"].createElement("svg", { viewBox: viewBox, xmlns: "http://www.w3.org/2000/svg", height: '100%', width: '100%' },
            ...
            bubbleData.map(function (d, idx) {
                ...
                return (react_1["default"].createElement("g", { key: d.id, className: 'leaf', transform: "translate(" + translation.x + "," + translation.y + ")", onClick: function () {
                    ...
                    react_1["default"].createElement("circle", { r: r, fill: utils_1.getBubbleFillColor(isWorker, d.data.Assessment), strokeWidth: isWorker ? 0 : 2, stroke: 'darkgray' }),
                    react_1["default"].createElement("text", null,
                        react_1["default"].createElement("textPath", { href: "#" + (isWorker ? 'worker' : 'grouping') + "-text-arc-" + d.r, fill: utils_1.getTextcolor(isWorker, d.data.Assessment), textAnchor: 'middle', startOffset: '50%', fontSize: isWorker
