...
var utils_1 = require("./utils"); // const legendSize = height * 0.001
...
var BubbleChart = function BubbleChart() {
  var _a = react_1.useState(defaultViewBox),
      viewBox = _a[0],
      setViewBox = _a[1];

  var textArcPaths = {};
  var stratifiedData = react_1.useContext(WorkerDataProvider_1.WorkerDataContext).stratifiedData;
  var bubbleData = stratifiedData && stratifiedData ? d3_1.pack().padding(0.005)(stratifiedData).descendants() : [];
  textArcPaths = (bubbleData === null || bubbleData === void 0 ? void 0 : bubbleData.reduce(function (memo, d) {
    if (memo[d.r]) return memo;
    var r = d.r * tokens_1.height;
    var groupingR = r;
    var workerR = r * 0.7;

    var getTextPath = function getTextPath(R) {
  ...
  return react_1["default"].createElement("div", null, react_1["default"].createElement("button", {
  ...
  }, "Reset zoom"), react_1["default"].createElement("svg", {
    viewBox: viewBox,
    xmlns: "http://www.w3.org/2000/svg",
    height: '100%',
    width: '100%'
  }, react_1["default"].createElement("rect", {
    height: tokens_1.height + tokens_1.margin * 2,
    width: tokens_1.width + tokens_1.margin * 2,
    fill: "gainsboro",
    x: -tokens_1.margin,
    y: -tokens_1.margin
    ...
    var r = _a[0],
        paths = _a[1];
    return react_1["default"].createElement(react_1["default"].Fragment, null, react_1["default"].createElement("path", {
  ...
  }), bubbleData === null || bubbleData === void 0 ? void 0 : bubbleData.map(function (d, idx) {
    ...
    return react_1["default"].createElement("g", {
      ...
      r: r,
      fill: utils_1.getBubbleFillColor(isWorker, d.data.Assessment),
      strokeWidth: isWorker ? 0 : 2,
      stroke: 'darkgray'
    }), react_1["default"].createElement("text", null, react_1["default"].createElement("textPath", {
      href: "#" + (isWorker ? 'worker' : 'grouping') + "-text-arc-" + d.r,
      fill: utils_1.getTextcolor(isWorker, d.data.Assessment),
      textAnchor: 'middle',
      startOffset: '50%',
      fontSize: isWorker ? d.r * tokens_1.height * 0.333 : d.r * tokens_1.height / (15 - d.depth * 1.5)
    }, d.data.Name)));
  })));
