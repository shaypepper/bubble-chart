...
var FileInput = function () {
  ...
  return react_1['default'].createElement(
    ...
    null,
    currentStep === dataFormattingReducer_1.Steps.LOAD_WORKERS &&
      react_1['default'].createElement(WorkersInput_1['default'], null),
    currentStep === dataFormattingReducer_1.Steps.CHOOSE_COLUMNS &&
      react_1['default'].createElement(MapColumns_1['default'], null),
    currentStep === dataFormattingReducer_1.Steps.LOAD_GROUPINGS &&
      react_1['default'].createElement(GroupingsInput_1['default'], null),
    currentStep === dataFormattingReducer_1.Steps.CHOOSE_COLOR_SCHEME &&
      react_1['default'].createElement(ColorPicker_1['default'], null),
    currentStep === dataFormattingReducer_1.Steps.DRAW &&
    ...
    stratifiedData &&
      react_1['default'].createElement(BubbleChart_1['default'], null),
    (_a = Array.from(unmappedGroupings || [])) === null || _a === void 0
      ? void 0
      : _a.map(function (m) {
          return react_1['default'].createElement('p', { key: m }, m)
        })
  )
}
