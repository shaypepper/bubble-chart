...
var MapColumns = function () {
    var _a = react_1.useContext(WorkerDataProvider_1.WorkerDataContext), columns = _a.columns, workersData = _a.workersData, dispatch = _a.dispatch, unmappedGroupings = _a.unmappedGroupings;
    var _b = react_1.useState({
        name: undefined,
        grouping: undefined,
        colorBasis: undefined
    }), tempColumnMap = _b[0], setTempColumnMap = _b[1];
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        Object.entries(tempColumnMap).map(function (_a) {
            var key = _a[0], label = _a[1];
            return (react_1["default"].createElement(react_bootstrap_1.Form.Group, { key: key },
