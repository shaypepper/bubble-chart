...
export const getStarPath = ({
  ...
  switch (whichStar) {
    ...
    case 2:
      return [
        `M${f(49.505)}   ${-0.5 + g(12)}`,
        `L${f(46.4356)}  ${-0.5 + g(19.5648)}`,
        `L${f(40)}       ${-0.5 + g(20.8083)}`,
        `L${f(45.636)}   ${-0.5 + g(25.7824)}`,
        `L${f(44.5545)}  ${-0.5 + g(32)}`,
        `L${f(49.55)}    ${-0.5 + g(29.2021)}`,
        `L${f(55.8416)}  ${-0.5 + g(32)}`,
        `L${f(53.644)}   ${-0.5 + g(24.8497)}`,
        `L${f(60)}       ${-0.5 + g(19.5648)}`,
        `H${f(52.362)}`,
        `L${f(49.505)}   ${-0.5 + g(12)}Z`,
      ].join('')
    case 3:
      return [
        `M${f(77.923)}  ${g(22.991)}`,
