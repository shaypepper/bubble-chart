...
function createColumnMap(state, columnMap) {
  var _a, _b, _c
  ;(_a = state.workersData) === null || _a === void 0
    ? void 0
    : _a.forEach(function (worker) {
  ...
  ;(_b = state === null || state === void 0 ? void 0 : state.workersData) ===
    null || _b === void 0
    ? void 0
    : _b.forEach(function (worker) {
        workerNameList.add(worker[nameKey])
      })
  var unlistedGroupingset = new Set()
  ;(_c = state === null || state === void 0 ? void 0 : state.workersData) ===
    null || _c === void 0
    ? void 0
    : _c.forEach(function (worker) {
        console.log(
          worker,
          groupingKey,
          workerNameList.has(worker[groupingKey])
        )
  ...
  var strat = d3_1
    ...
    .parentId(function (d) {
      return d === null || d === void 0
        ? void 0
        : d[state.columnMap.grouping || '']
    })
  if (!state.workersData || !state.groupingsData) {
    return state
  }
  var stratifiedData = strat(
    __spreadArrays(state.workersData, state.groupingsData)
  )
    .sum(function () {
      return 1
    })
    .sort(function (a, b) {
      return (
        ((b === null || b === void 0 ? void 0 : b.value) || 0) -
        ((a === null || a === void 0 ? void 0 : a.value) || 0)
      )
    })
