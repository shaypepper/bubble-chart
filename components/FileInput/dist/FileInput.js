...
var FileInput = function () {
    ...
    return (react_1["default"].createElement(react_bootstrap_1.Form, null,
        ...
        !workersData && (react_1["default"].createElement(react_bootstrap_1.Form.Group, null,
            react_1["default"].createElement(react_bootstrap_1.Form.Label, { htmlFor: "outreach-data" },
                "Upload your outreach data:",
                react_1["default"].createElement(react_bootstrap_1.Form.Control, { className: 'form-control', ref: outreachDataInputRef, type: "file", name: "outreach-data", accept: ".csv", onChange: function () {
                        if (!outreachDataInputRef.current)
                            return;
        ...
        !!(unmappedGroupings === null || unmappedGroupings === void 0 ? void 0 : unmappedGroupings.size) && (react_1["default"].createElement(react_bootstrap_1.Form.Group, null,
            react_1["default"].createElement(react_bootstrap_1.Form.Label, { htmlFor: "grouping-data" },
                "It seems that you are missing some grouping data. There are",
                ' ',
                Array.from(unmappedGroupings || []).length,
                " workers whose groupings haven't been uploaded (Ex.",
                ' ',
                Array.from(unmappedGroupings || [])
                    .slice(0, 2)
                    .join(', '),
                "...). Upload your grouping data here:",
                react_1["default"].createElement(react_bootstrap_1.Form.Control, { className: 'form-control', ref: groupingListInputRef, type: "file", name: "outreach-data", accept: ".csv", onChange: function () {
                        if (!groupingListInputRef.current)
                            return;
